...
CreateThread(function()
    while true do
        SafeCodes = {
            [1] = {math.random(1, 149), math.random(500.0, 600.0), math.random(360.0, 400), math.random(600.0, 900.0)},
            ...
            [4] = {math.random(150, 359), math.random(-300.0, -60.0), math.random(0, 100), math.random(-500.0, -160.0)},
            [5] = {math.random(150, 359), math.random(-300.0, -60.0), math.random(0, 100), math.random(-500.0, -160.0)},
            ...
            [7] = {math.random(1, 149), math.random(150.0, 200.0), math.random(100, 140), math.random(150.0, 220.0), math.random(-100, 100), math.random(140, 300)},
            [8] = {math.random(1, 149), math.random(150.0, 200.0), math.random(100, 140), math.random(150.0, 220.0), math.random(-100, 100), math.random(140, 300)},
            [9] = {math.random(1, 149), math.random(300.0, 500.0), math.random(200, 260), math.random(500.0, 800.0), math.random(300, 440), math.random(650, 900)},
            ...
            [11] = {math.random(1, 149), math.random(300.0, 500.0), math.random(200, 260), math.random(500.0, 800.0), math.random(300, 440), math.random(650, 900)},
            [12] = {math.random(1, 149), math.random(300.0, 500.0), math.random(200, 260), math.random(500.0, 800.0), math.random(300, 440), math.random(650, 900)},
            [13] = {math.random(1, 149), math.random(300.0, 500.0), math.random(200, 260), math.random(500.0, 800.0), math.random(300, 440), math.random(650, 900)},
            [14] = {math.random(150, 450), math.random(-360.0, 0.0), math.random(360, 720)},
            [15] = {math.random(150, 450), math.random(-360.0, 0.0), math.random(360, 720)},
            [16] = {math.random(150, 450), math.random(-360.0, 0.0), math.random(360, 720)},
            [17] = {math.random(150, 450), math.random(-360.0, 0.0), math.random(360, 720)},
            ...
            [19] = {math.random(150, 450), math.random(-360.0, 0.0), math.random(360, 720)},
        }
        Wait((1000 * 60) * 40)
    end
end)
