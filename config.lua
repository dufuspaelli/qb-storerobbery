...
Config.Safes = {
    [1] = {vector4(-43.43, -1748.3, 29.42,  52.5), type = "padlock", robbed = false, camId = 4}, 
    ...
    [4] = {vector4(-709.74, -904.15, 19.21, 229.5), type = "padlock", robbed = false, camId = 7},
    [5] = {vector3(28.21, -1339.14, 29.49), type = "padlock", robbed = false, camId = 8},
    [6] = {vector3(1126.77, -980.1, 45.41), type = "padlock", robbed = false, camId = 9},
    [7] = {vector3(1159.46, -314.05, 69.2), type = "padlock", robbed = false, camId = 10},
    [8] = {vector3(378.17, 333.44, 103.56), type = "padlock", robbed = false, camId = 11},
    [9] = {vector3(-1829.27, 798.76, 138.19), type = "padlock", robbed = false, camId = 12},
    [10] = {vector3(-2959.64, 387.08, 14.04), type = "padlock", robbed = false, camId = 13},
    [11] = {vector3(-3047.88, 585.61, 7.9), type = "padlock", robbed = false, camId = 14},
    [12] = {vector3(-3250.02, 1004.43, 12.83), type = "padlock", robbed = false, camId = 15},
    [13] = {vector3(546.41, 2662.8, 42.15), type = "padlock", robbed = false, camId = 16},
    [14] = {vector3(1169.31, 2717.79, 37.15), type = "padlock", robbed = false, camId = 17},
    [15] = {vector3(2672.69, 3286.63, 55.24), type = "padlock", robbed = false, camId = 18},
    [16] = {vector3(1959.26, 3748.92, 32.34), type = "padlock", robbed = false, camId = 19},
    [17] = {vector3(1734.78, 6420.84, 35.03), type = "padlock", robbed = false, camId = 20},
    [18] = {vector3(-168.40, 6318.80, 30.58), type = "padlock", robbed = false, camId = 27},
    [19] = {vector3(168.95, 6644.74, 31.70), type = "padlock", robbed = false, camId = 30},
}
